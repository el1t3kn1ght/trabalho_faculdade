...
class _CadastroSinistroScreen extends State<CadastroSinistroScreen> {
  ...
  @override
  Future<void> addSinistro(String? tipoSinistro, String? tipoVeiculo,
      String? localSinistro,
      String? dataSinistro) {
    CollectionReference sinistro = FirebaseFirestore.instance.collection(
        'sinistro');
    return sinistro
        .add({
        ...
        .then((value) =>
    {
      ScaffoldMessenger.of(context)
          .showSnackBar(
          SnackBar(content: Text("Sinistro Cadastrado com sucesso!")))
    })
        .catchError((error) =>
    {
      ScaffoldMessenger.of(context)
      ...
      Padding(
        ...
        Container(
            ...
            child: Column(
              children: <Widget>[
                TextField(
                  decoration: InputDecoration(label: Text("TIPO DO SINISTRO"),
                ...
                Padding(
                  ...
                  child: TextButton(
                    onPressed: () {
                      addSinistro(
                          _tipoSinistro, _tipoVeiculo, _localSinistro,
                          _dataSinistro);
                    },
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: () async {
                ...
                final Sinistro novoSinistro = Sinistro(
                    tipoSinistro, tipoVeiculo, local, data);
                print(novoSinistro);
