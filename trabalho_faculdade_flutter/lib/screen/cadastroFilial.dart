...
class _CadastroFilialScreen extends State<CadastroFilialScreen> {
  String _nome = "", _endereco = "", _cnpj = "", _telefone = "";

  @override
  Future<void> addFilial(
      String? nome, String? endereco, String? cnpj, String? telefone) {
    CollectionReference filial =
    ...
    return filial
        ...
        .then((value) => {
              ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text("Filial Cadastrada com sucesso!")))
            })
        .catchError((error) => {
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: TextButton(
                    onPressed: () {
                      addFilial(_nome, _endereco, _cnpj, _telefone);
                    },
