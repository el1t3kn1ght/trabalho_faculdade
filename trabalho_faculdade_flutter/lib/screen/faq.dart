...
class Faq extends StatelessWidget {
  ...
  Widget buildText(BuildContext context) => ExpansionTile(
      ...
      Widget buildText3(BuildContext context) => ExpansionTile(
       ...
       Widget buildText6(BuildContext context) => ExpansionTile(
        title: Text(
       ...
       Widget buildText7(BuildContext context) => ExpansionTile(
        title: Text(
        ...
        Widget buildText8(BuildContext context) => ExpansionTile(
        title: Text(
        ...
        Widget buildText9(BuildContext context) => ExpansionTile(
        title: Text(
        ...
        children: [
          ...
          Widget buildText10(BuildContext context) => ExpansionTile(
         title: Text(
        ...
        Widget buildText11(BuildContext context) => ExpansionTile(
         title: Text(
